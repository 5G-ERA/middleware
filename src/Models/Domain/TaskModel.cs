...
namespace Middleware.Models.Domain
{
    public class TaskModel : BaseModel
    {
        ...
        [JsonPropertyName(
            "ReplanActionPlannerLocked")] // True: The robot requests to not change anything from action sequence but placement.
        ...
        public bool
            MarkovianProcess { get; set; } //Check if  actions in action sequence are sequential or affect each other.
