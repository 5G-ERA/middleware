...
public class ActionController : ControllerBase
{
    ...
    public ActionController(IActionRepository actionRepository, IActionPlanRepository actionPlanRepository,
        ILogger<ActionController> logger, IActionService actionService,
        IHistoricalActionPlanRepository historicalActionPlanRepository,
        IActionRunningRepository actionRunningRepository)
    {
        ...
        try
        {
            ...
            if (deleted == false)
            {
                return NotFound(new ApiResponse((int)HttpStatusCode.NotFound,
                    "The specified plan has not been found."));
            }
    ...
    public async Task<IActionResult> PatchActionPlanAsync(Guid id, [FromBody] ActionPlanModel actionPlan)
    {
        try
        {
            ...
            {
                return BadRequest(new ApiResponse((int)HttpStatusCode.BadRequest,
                    "Id or updated object has not been specified"));
            }
    ...
    public async Task<IActionResult> AddHistoricalActionPlanAsync(HistoricalActionPlanModel historicalActionPlan)
    {
        try
        {
            ...
            var plan = await _historicalActionPlanRepository.AddAsync(historicalActionPlan,
                () => historicalActionPlan.Id);
            if (plan == null)
            {
                return BadRequest(new ApiResponse((int)HttpStatusCode.BadRequest,
                    "The specified historical plan has not been added."));
            }
    ...
    public async Task<IActionResult> DeleteHistoricalActionPlanAsync(Guid id)
    {
        try
        {
            ...
            {
                return NotFound(new ApiResponse((int)HttpStatusCode.NotFound,
                    "The specified historical plan has not been found."));
            }
    ...
    [ProducesResponseType(typeof(ApiResponse), (int)HttpStatusCode.BadRequest)]
    [ProducesResponseType(typeof(ApiResponse), (int)HttpStatusCode.InternalServerError)]
    public async Task<IActionResult> PatchHistoricalActionPlanAsync(Guid id,
        [FromBody] HistoricalActionPlanModel historicalActionPlan)
    {
        try
        {
    ...
    public async Task<IActionResult> GetHistoricalActionPlanByRobotIdAsync(Guid robotId)
    {
        try
        {
            ...
            // Get list of actionPlans from specific robotId.
            List<HistoricalActionPlanModel> historicalActionPlans =
                await _historicalActionPlanRepository.GetRobotActionPlans(robotId);
    ...
    public async Task<IActionResult> GetLatestHistoricalActionPlanByRobotIdAsync(Guid robotId)
    {
        try
        {
            ...
            // Get list of actionPlans from specific robotId.
            List<HistoricalActionPlanModel> actionPlans =
                await _historicalActionPlanRepository.GetRobotActionPlans(robotId);

            //Get the newest task of robot.
            Dictionary<HistoricalActionPlanModel, DateTime> tempDic =
                new Dictionary<HistoricalActionPlanModel, DateTime>();
            Dictionary<HistoricalActionPlanModel, DateTime> OrderedTempDic =
                new Dictionary<HistoricalActionPlanModel, DateTime>();
    ...
    public async Task<IActionResult>
        GetActionRunningRelationAsync(Guid id, string name) //Guid of node and name of relationship
    {
