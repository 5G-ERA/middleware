...
public interface IPublishService
{
    ...
    /// <param name="instanceId">Unique identifier of the deployed instance</param>
    /// <returns></returns>
    Task PublishSwitchoverDeleteInstance(Guid actionPlanId, Guid instanceId);
    /// <summary>
    ...
    /// <returns></returns>
    Task PublishSwitchoverDeployInstance(Guid actionPlanId, Guid instanceId, string location, string locationType);
}