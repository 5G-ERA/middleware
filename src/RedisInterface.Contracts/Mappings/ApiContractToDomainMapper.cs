...
public static class ApiContractToDomainMapper
{
    ...
    public static InstanceModel ToInstance(this InstanceRequest x)
    {
        return new()
        {
            ...
            ServiceType = x.Type,
            Ram = new(x.Ram.Minimum, x.Ram.Optimal, x.Ram.Priority, true),
            NumberOfCores = new(x.NumberOfCores.Minimum, x.NumberOfCores.Optimal, x.NumberOfCores.Priority, true),
            DiskStorage = new(x.DiskStorage.Minimum, x.DiskStorage.Optimal, x.DiskStorage.Priority, true),
            Throughput = new(x.Throughput.Minimum, x.Throughput.Optimal, x.Throughput.Priority, true),
